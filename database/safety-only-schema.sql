-- Safety Only Schema Script
-- This script creates only the safety-related tables and policies
...
BEGIN
    ...
    -- Create RLS policies for safety tables only
    ...
    RAISE NOTICE 'Created all safety RLS policies';
